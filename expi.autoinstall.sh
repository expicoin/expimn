...
echo -e "${GREEN} ------- EXPi MASTERNODE INSTALLER v1.0.2--------+
 |                                                  |
 |                                                  |::
...
wget https://github.com/expicoin/expicore/releases/download/v1.0.2/expi-linux-daemon-1.0.2.tgz
tar -xvf expi-linux-daemon-1.0.2.tgz
